...
namespace Simnet
{
    ...
    */
    ...
    struct PGN65305Payload
    {
        ...
        PGN65305Payload(const ApStatus &status)
        {
        ...
        PGN65305Payload(const ApMode &mode)
        {
        ...
        PGN65305Payload(const ApChange &change)
        {
    ...
    void SetN2kPGN6305(tN2kMsg &msg, const ApMsgType &mode, const PGN65305Payload &payload = PGN65305Payload());

    inline void
    SetSimnetStatus(tN2kMsg &N2kMsg, const ApStatus &status)
    {
        SetN2kPGN6305(N2kMsg, ApMsgType::Status, PGN65305Payload(status));
    }

    inline void SetSimnetMode(tN2kMsg &N2kMsg, const ApMode &mode)
    {
        SetN2kPGN6305(N2kMsg, ApMsgType::Mode, PGN65305Payload(mode) /*PGN65305Payload(status) mode*/);
    }

    // Might not need this one
    inline void SetSimnetStatusChange(tN2kMsg &N2kMsg, const ApChange &change)
    {
        SetN2kPGN6305(N2kMsg, ApMsgType::Change, PGN65305Payload(change));
    }
    ...
    enum class ApDirection : uint8_t
    {
        Zero = 0,
        Port = 2,
        Starboard = 3,
    ...
    void ParsePgn130850Ap(const tN2kMsg &msg, uint8_t &addr, Command &simnetcmd, ApStatus &apStatus, ApCommand &apcmd, ApDirection &dir, double &angle);
    ...
    */
    ...
    void SetPGN65340(tN2kMsg &msg, const ApState &state /*const Mode &mode*/ /*Mode63540 &mode*/);

    void SetPGN65341(tN2kMsg &msg, const ApState &state, const double &angle);
